...
const Notes = () => {
    ...
    const fetchNotes = async () => {
        ...
        const response = await query(notesCollection, where("uid", "==", user.uid));
    ...
    return (
        ...
        >
            <div className='flex justify-end w-full'>
                <button className='bg-red-600 text-white p-2 cursor-pointer' onClick={handleLogout}>Log Out</button>
            </div>
