        ...
        <div id="busList" className="w-max-[80%] mx-auto">
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  <br />
                  <br />
                  <button className="bg-indigo-600 p-4 text-white hover:cursor-pointer hover:bg-indigo-700" 
          ...
          {seatVisibility && (
            <button
              ...
              className="bg-indigo-600 p-4 text-white hover:cursor-pointer hover:bg-indigo-800 fixed top-[10%] right-[10%]"
            >
              X
            </button>
          )}
