  ...
  return (
    <>
      <div className="m-10 text-lg relative">
        ...
        <ol className="">
          <li>
            1. Total duration of JEE-Main - 40503627_BTECH 9th Jan 2020 Shift 2
            is 180 min.
          </li>
          <li>
          ...
          <li id="symbols">
            ...
            <ol className="mx-3">
              <li className="flex m-2">
                {" "}
                <div
                  className="notvisited text-center border-2 border-slate-500 bg-slate-100 w-7 h-7 mx-2 rounded"
                  id="notvisitedCount"
                >
                  1
                </div>{" "}
              ...
              <li className="flex m-2">
                {" "}
                <div
                  className="notanswered text-center bg-red-600 text-white w-7 h-7 mx-2 rounded"
                  id="notansweredCount"
                >
                  2
                </div>
              ...
              <li className="flex m-2">
                {" "}
                <div
                  className="answered text-center bg-green-600 text-white w-7 h-7 mx-2 rounded"
                  id="answeredCount"
                >
                  3
                </div>
              ...
              <li className="flex m-2">
                {" "}
                <div
                  className="review text-center bg-indigo-800 text-white w-7 h-7 mx-2 rounded-full"
                  id="reviewCount"
                >
                  4
                </div>{" "}
              ...
              <li className="flex m-2">
                {" "}
                <div
                  className="ansNreview text-center bg-blue-500 text-white w-7 h-7 mx-2 rounded-full"
                  id="ansNreviewCount"
                >
                  5
                </div>{" "}
          ...
          <li>
            3. You can click on the &quot;&gt;&quot; arrow which apperes to the
          ...
          <li>
            4. You can click on your &quot;Profile&quot; img on top right corner
            of your screen to change the language during the exam for entire
            question paper. On clicking of Profile img you will get a drop-down
            to change the question content to the desired language.
          </li>
          <li>
            5. Each question has five options out of which only one option will
            be correct.
          </li>
          <li>
            6. You can click on to navigate to the bottom and to navigate to top
            of the question are, without scrolling.
          </li>
        </ol>
        <h2 className="font-semibold underline mt-4">Navigation to Question</h2>
        <ol start="{7}">
          <li>
        ...
        <ol start="{8}">
          <li>
            ...
            <ol className="mx-5">
              <li>
                a. To select you answer, click on the button of one of the
                options.
              </li>
              <li>
                b. To deselect your chosen answer, click on the button of the
        ...
        <label htmlFor="confirm">
          <p className="my-4">
            <input type="checkbox" id="confirm" className="mx-3" ref={ref} />I
        ...
        <div className="btndiv flex justify-center">
          <button
            className="btn w-72 h-10 bg-blue-500 text-white my-3 hover:cursor-pointer hover:bg-red-700"
            id="proceed"
            onClick={handleClick}
          >
            START
        ...
        <div className="fixed top-1/2 left-[40%] h-72 w-72">
          {visible && (
            <div className="bg-yellow-300 text-center h-72 w-80 flex flex-col justify-center p-5">
              ...
              <button
                className="bg-red-500 text-white w-15 hover:bg-orange-400"
                onClick={handleClick}
              >
                OK
              </button>
